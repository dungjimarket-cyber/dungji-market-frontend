...
export default function RichTextEditor({
  ...
  return (
    <div className="border border-slate-300 rounded-lg overflow-hidden">
        ...
        <div className="relative">
          ...
          {showColorPicker && (
            <div className="absolute top-full mt-1 left-0 bg-white border border-slate-200 rounded-lg shadow-lg p-3 z-50">
              ...
              <button
                type="button"
                className="mt-3 w-full text-xs text-slate-600 hover:text-slate-900 py-1.5"
                onClick={() => {
      ...
      {/* 에디터 */}
      <div
        className="text-slate-700 text-sm leading-relaxed [&_.ProseMirror>p]:mb-3 [&_.ProseMirror>p]:mt-0 [&_.ProseMirror>ul]:mb-3 [&_.ProseMirror>ol]:mb-3 [&_.ProseMirror>h1]:mb-3 [&_.ProseMirror>h2]:mb-3 [&_.ProseMirror>h3]:mb-3 [&_.ProseMirror]:p-5"
