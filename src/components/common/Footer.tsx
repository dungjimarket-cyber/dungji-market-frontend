...
export default function Footer() {
  ...
  return (
    <footer className="border-t mt-1 sm:mt-2 md:mt-4 py-1 sm:py-2 md:py-2 bg-gray-50 mb-20 md:mb-0">
        ...
        <div className="block md:hidden">
          ...
          <div className="relative flex mb-4">
            ...
            <div className="flex-1 pr-3 flex justify-center">
              <div>
                <p className="text-sm font-medium text-gray-700 mb-2">둥지마켓</p>
                <div className="text-[11px] text-gray-600 space-y-0.5">
                  <p>대표: 김성민</p>
                  <p>사업자: 275-23-02159</p>
                  <p className="leading-tight">통신판매업:<br/>제2025-경기하남-1650호</p>
                  <p className="leading-tight">경기도 하남시 검단산로<br/>239, B1층 26호</p>
                </div>
              </div>
            </div>
            ...
            {/* 연락처 (오른쪽) */}
            <div className="flex-1 pl-3 flex justify-center">
              <div>
                {/* 카카오톡 버튼 */}
                <a
                  ...
                  className="inline-flex items-center px-2.5 py-1 bg-yellow-400 hover:bg-yellow-500 text-black text-[11px] font-medium rounded-lg transition-colors duration-200 mb-2"
                >
                ...
                <div className="space-y-0.5">
                  <div>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center text-[11px] text-gray-600 hover:text-pink-600 transition-colors duration-200"
                    >
                  ...
                  <div>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center text-[11px] text-gray-600 hover:text-green-600 transition-colors duration-200"
                    >
                      <div className="w-3.5 h-3.5 bg-green-500 rounded text-white flex items-center justify-center font-bold text-[9px] mr-1">
                        N
                      </div>
                      블로그
                    </a>
                  ...
                  <div>
                    <a href="tel:070-4507-4492" className="text-[11px] text-gray-600 hover:text-emerald-600 transition-colors">
                      ☎️ 070-4507-4492
                    </a>
                  </div>
                </div>
          ...
          <div className="text-center space-y-1 mb-4">
            <div className="flex flex-wrap justify-center gap-x-3 gap-y-1 text-xs text-gray-600">
              <div className="relative">
                ...
                {isExpanded && (
                  <div className="absolute top-full left-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-10 whitespace-nowrap">
                    <Link href="/terms/general" className="block px-3 py-2 text-xs hover:bg-gray-50 hover:text-emerald-600 transition-colors">
                      일반회원 이용약관
                    </Link>
                    <Link href="/terms/seller" className="block px-3 py-2 text-xs hover:bg-gray-50 hover:text-emerald-600 transition-colors">
                      판매회원 이용약관
                    </Link>
                  </div>
                )}
              ...
              <Link href="/used/guide" className="hover:text-emerald-600 transition-colors">중고거래가이드</Link>
              <span className="text-gray-400">|</span>
              <Link href="/privacy" className="hover:text-emerald-600 transition-colors">개인정보처리방침</Link>
            </div>
            <div className="flex flex-wrap justify-center gap-x-3 gap-y-1 text-xs text-gray-600">
              <Link href="/faq" className="hover:text-emerald-600 transition-colors">FAQ</Link>
              <span className="text-gray-400">|</span>
              <Link href="/notices" className="hover:text-emerald-600 transition-colors">공지사항</Link>
              <span className="text-gray-400">|</span>
              <Link href="/inquiries" className="hover:text-emerald-600 transition-colors">1:1문의</Link>
            </div>
          </div>
