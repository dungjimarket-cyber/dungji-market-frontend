...
function HomeContent() {
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-1 md:py-6 pb-28 md:pb-8 max-w-full">
      ...
      <section className="mb-12">       
        <div className="grid grid-cols-2 sm:flex sm:flex-row justify-center items-center gap-2 mb-8 mt-4">
          ...
          <a
            ...
            className="btn-animated btn-purple whitespace-nowrap px-3 py-4 sm:px-6 sm:py-2 flex items-center justify-center w-full sm:w-auto"
          >
