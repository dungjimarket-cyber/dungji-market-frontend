...
export const metadata: Metadata = {
  ...
  description: "커스텀 공구 할인, 공동구매 비교견적, 중고거래를 한번에 제공하는 통합 플랫폼\n✓ 커스텀 공구 - 인원 모집 특별 할인 (수수료 무료)\n✓ 휴대폰·인터넷 비교견적 서비스\n✓ 전국 판매점 연결\n✓ 지역기반 중고직거래 서비스",
  keywords: "둥지마켓, 커스텀 공구, 공동구매 할인, 단체 할인, 휴대폰 공동구매, 인터넷 비교견적, 휴대폰 지원금, 인터넷 가입, 통신사 비교, SKT, KT, LGU+, 중고폰, 지역중고거래, 직거래, 온라인 할인코드, 오프라인 할인",
  authors: [{ name: '둥지마켓' }],
  creator: '둥지마켓',
  publisher: '둥지마켓',
  robots: {
