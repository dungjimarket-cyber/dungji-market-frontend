...
const faqData: FAQItem[] = [
  // 🏠 둥지마켓 이용 안내
  {
    ...
    answer: "둥지마켓은 \"내가 원하는 상품/서비스의 견적을 판매자들이 서로 경쟁하여 최고의 조건으로 제안하는\" 공동구매 견적 서비스입니다.\n예를 들어, 일반회원이 아이폰을 공구에 등록하면 함께 구매할 소비자들이 공구에 참여하고, 동시에 판매회원들이 자유롭게 견적을 제안하면, 최고 견적에 선정된 판매회원을 연결해드리는 방식입니다."
  },
  {
    question: "Q2. 일반 쇼핑몰과 뭐가 다른가요?",
    answer: "- 견적중개플랫폼: 공동구매 참여자에게 판매자가 견적을 자유롭게 제안하는 중개플랫폼입니다.\n- 혼자서도 가능해요: 여러명이 참여하면 좋지만, 혼자서도 견적을 받을 수 있어요.\n- 지역 기반 거래: 내 지역 판매자와 직접 거래를 지향합니다.\n- 최종 선택기회 제공: 견적 결과에 따라 구매확정/포기 선택, 판매자는 구매자 확정률에 따라 판매확정/포기 선택이 가능합니다."
  },
  
  // 👥 회원 가입 및 유형
  {
    question: "Q3. 일반회원과 판매회원의 차이는 무엇인가요?",
    answer: "- 🐦 일반회원: 공구에 참여하여 상품을 구매하는 회원\n  - 공구 등록 및 참여 가능\n  - 최저가 혜택 받기\n  - 카카오톡 간편가입 가능\n\n- 🦅 판매회원: 견적을 제안하여 상품을 판매하는 회원\n  - 견적 제안하기\n  - 상품 판매 가능\n  - 사업자 정보 등록 필요"
  },
  {
  ...
  // 🎫 견적티켓 시스템
  {
    question: "Q11. 견적이용권은 무엇인가요?",
    answer: "판매회원이 공구에 견적을 제안하기 위해 필요한 이용권입니다.\n- 개별 견적이용권: 건당 결제\n- 무제한 구독권: 월 정액제로 무제한 견적 제안 가능"
  },
