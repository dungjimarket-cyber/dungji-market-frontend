    ...
    <div className="container mx-auto px-4 py-6 max-w-3xl text-sm">
        ...
        <div className="p-4">
          <div className="mb-6">
            ...
            <ul className="list-disc pl-4 mb-3 space-y-1 text-xs">
              <li>
                "일반회원"이란 본 약관에 동의하고 회사가 제공하는 서비스에 가입한 개인 사용자로서,
                전문가 상담 신청, 공동구매 개설 및 참여, 중고거래를 이용할 수 있는 회원을 말합니다.
              </li>
              <li>
                "전문가회원"이란 세무사, 회계사, 변호사, 법무사, 공인중개사, 인테리어, 이사, 청소 등
                전문 서비스를 제공하는 사업자로서, 일반회원의 상담 요청에 응대하는 회원을 말합니다.
              </li>
              <li>
                "서비스"란 회사가 운영하는 플랫폼에서 전문가 상담 연결, 공동구매 개설 및 참여, 중고거래 등의 기능을 통해
                전문 서비스 및 제품을 거래할 수 있도록 제공하는 온라인 기반의 중개 시스템을 의미합니다.
              </li>
              <li>
                "상담 신청"이란 일반회원이 특정 분야의 전문가에게 상담을 요청하는 행위를 의미합니다.
              </li>
              <li>
                "상담 응대"란 전문가회원이 일반회원의 상담 요청에 대해 연락 및 상담을 진행하는 행위를 의미합니다.
              </li>
              <li>
                "공구"란 일반회원이 제품 또는 서비스를 공동으로 구매하고자 개설하거나 참여하는 공동구매 활동을 말합니다.
              </li>
              <li>
                "중고거래"란 일반회원 간 중고 휴대폰, 전자제품 등을 직거래 방식으로 사고파는 활동을 말합니다.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-4 mb-3 space-y-1 text-xs">
              ...
              <li>
                ...
                <ul className="list-disc pl-4 mt-1 text-xs">
                  ...
                  <li>반복적인 공구 참여 철회, 구매 확정 후 포기 등 서비스 질서 훼손</li>
                  <li>중고거래 시 상습적인 노쇼(no-show) 또는 허위 매물 등록</li>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8" id="privacy">
        ...
        <div className="p-4">
          ...
          <ul className="list-disc pl-4 mb-3 space-y-1 text-xs">
            <li>회원 식별 및 본인확인</li>
            <li>공동구매 참여, 견적 선정 결과 안내 및 중고거래 서비스 제공</li>
