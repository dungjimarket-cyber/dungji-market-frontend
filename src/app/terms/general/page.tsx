          ...
          <div className="mb-6">
            ...
            <ul className="list-disc pl-4 mb-3 space-y-1 text-xs">
              <li>
                ...
                공동구매를 개설하거나 참여하고 중고거래를 이용할 수 있는 회원을 말합니다.
              </li>
              <li>
                "서비스"란 회사가 운영하는 플랫폼에서 공동구매 개설 및 참여, 중고거래 등의 기능을 통해
                제품 또는 서비스를 거래할 수 있도록 제공하는 온라인 기반의 중개 시스템을 의미합니다.
              </li>
              <li>
                "공구"란 일반회원이 제품 또는 서비스를 공동으로 구매하고자 개설하거나 참여하는 공동구매 활동을 말합니다.
              </li>
              <li>
                "견적제안"이란 공구에 대해 판매회원(사업자)이 가격 및 조건을 제안하는 행위를 의미합니다.
              </li>
              <li>
                "견적 선정"이란 여러 견적제안 중 최적의 조건이 자동으로 선택되어 해당 판매회원이 확정되는 것을 말합니다.
              </li>
              <li>
