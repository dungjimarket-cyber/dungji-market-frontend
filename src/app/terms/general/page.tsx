...
export default function GeneralTermsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <h1 className="text-3xl font-bold mb-8 text-center">둥지마켓 일반회원 이용약관</h1>

      {/* 일반회원 이용약관 */}
      <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
        <div className="bg-emerald-600 text-white p-4">
          <h2 className="text-xl font-semibold">📄 [둥지마켓] 회원가입 약관 (필수)</h2>
        </div>
        <div className="p-6">
          <div className="mb-6">
            ...
            <h2 className="text-xl font-semibold mb-3">제8조 (기타 조항)</h2>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8" id="privacy">
        <div className="bg-blue-600 text-white p-4">
          <h2 className="text-xl font-semibold">[둥지마켓] 일반회원 개인정보 수집 및 이용 동의서 (필수)</h2>
        </div>
        <div className="p-6">
          <p className="mb-4">둥지마켓(이하 "회사")은 회원가입 및 서비스 제공을 위하여 아래와 같이 개인정보를 수집·이용합니다.</p>
