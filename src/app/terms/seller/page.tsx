    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
        ...
        <div className="p-6">
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>회사는 판매회원에게 공동구매 입찰 참여 기회를 제공하며, 판매회원은 입찰 방식에 따라 자유롭게 참여할 수 있습니다.</li>
            <li>회사는 플랫폼의 기술적 중개 역할만 수행하며, 판매회원은 최종 판매책임을 전적으로 부담합니다.</li>
            <li>판매회원은 회사의 공구 등록, 입찰, 낙찰 시스템에 따라 공정하고 신의성실한 거래를 수행해야 합니다.</li>
          </ul>

          <h2 className="text-xl font-semibold mb-3">제4조 (입찰권 제도)</h2>
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>판매회원은 공구에 입찰을 진행하기 위해 "입찰권"을 사용해야 하며, 1개의 입찰 당 1매의 입찰권이 차감됩니다.</li>
            <li>신규 가입 시 판매회원에게는 프로모션으로 무료 입찰권 10매가 제공됩니다.</li>
            <li>입찰권은 유료로 추가 구매할 수 있으며, 사용한 입찰권은 반환되지 않습니다.</li>
            <li>입찰 후 낙찰이 되지 않더라도 입찰권은 환불되지 않습니다.</li>
            <li>시스템 오류 또는 사전 고지된 유지보수 등의 이유로 입찰이 정상 처리되지 않은 경우, 회사는 입찰권을 복구 또는 재지급할 수 있습니다.</li>
          </ul>

          <h2 className="text-xl font-semibold mb-3">제5조 (낙찰 및 판매 확정 의무)</h2>
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>입찰이 낙찰된 판매회원은 플랫폼 상 "판매 확정" 절차를 완료해야 하며, 이후 해당 공구 참여 고객에게 제품/서비스를 제공해야 합니다.</li>
            <li>낙찰 후 판매를 포기할 경우, 아래의 패널티 정책이 적용됩니다 (패널티 세부 사항은 별도 동의서 참조).</li>
            <li>낙찰 시 제공된 고객 정보는 판매 목적 외에 사용할 수 없으며, 외부 유출 시 민형사상의 책임을 부담합니다.</li>
          </ul>

          <h2 className="text-xl font-semibold mb-3">제6조 (이용 제한 및 자격 정지)</h2>
          <p className="mb-2">회사는 아래의 사유가 발생할 경우 판매회원의 입찰 권한을 일시 정지하거나, 판매회원 자격을 박탈할 수 있습니다.</p>
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>낙찰 확정 후 판매 거부</li>
