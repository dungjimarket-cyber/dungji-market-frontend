...
export default function SellerTermsPage() {
  return (
    <div className="container mx-auto px-4 py-6 max-w-3xl text-sm">
      ...
      <h1 className="text-xl font-bold mb-6 text-center">둥지마켓 판매회원 약관</h1>

      {/* 판매회원 전용 약관 */}
      <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
        <div className="bg-purple-600 text-white p-3">
          <h2 className="text-base font-semibold">📄 [둥지마켓] 판매회원 전용 약관 (필수)</h2>
        </div>
        <div className="p-4">
          ...
          <h2 className="text-base font-semibold mb-2">제2조 (판매회원 자격 및 가입 절차)</h2>
          ...
          <h2 className="text-base font-semibold mb-2">제7조 (개인정보의 수집 및 이용)</h2>
          ...
          <p className="mb-3 text-xs">회사는 판매회원 탈퇴 시까지 개인정보를 보관하며, 「전자상거래 등에서의 소비자보호에 관한 법률」 등 관련 법령에 따라 일정 기간 동안 보관이 필요한 정보는 해당 기간 동안 보관합니다.</p>
          
          <h3 className="text-lg font-semibold mb-2 mt-4">개인정보 처리방침 연계</h3>
          <p className="mb-3 text-xs">기타 개인정보 처리에 관한 상세한 내용은 회사의 "개인정보처리방침"을 따릅니다.</p>

          <h2 className="text-base font-semibold mb-2">제8조 (기타)</h2>
          <ul className="list-disc pl-4 mb-3 space-y-1 text-xs">
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
        <div className="bg-indigo-600 text-white p-4">
          <h2 className="text-base font-semibold">📄 [둥지마켓] 판매회원 개인정보 수집 및 이용 동의서 (필수)</h2>
        </div>
        <div className="p-4">
          <p className="mb-3 text-xs">둥지마켓(이하 "회사")는 판매회원의 입점 및 거래 관련 서비스 제공을 위해 다음과 같이 개인정보를 수집·이용합니다.</p>
